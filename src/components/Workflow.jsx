...
import { fadeRight, fadeLeft, normalFadeIn } from "../variants";
function Workflow() {
  return (
      ...
      <div className="flex flex-wrap justify-center">
        ...
        <div className="pt-12 w-full lg:w-1/2">
          {checklistItems.map((item, index) => (
            ...
            >
              <div
                className="text-green-400 mx-6 
              bg-neutral-900 h-10 w-10 p-2 justify-center items-center rounded-full"
              >
                <CheckCircle2 />
              </div>
              <div>
